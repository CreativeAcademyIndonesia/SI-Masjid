...
const jadwalsholat = () => {
    ...
    async function hapusJadwalSholat(id) {
        let res = await fetch(`/api/hapusjadwalsholat?id=${id}`, { method: 'DELETE' })
                            ...
                            <div className="modal-body">
                                <form onSubmit={submitHandler} className='container ' style={{ maxWidth: '500px' }}>
                                    ...
                                    <div className="form-group">
                                        ...
                                        <input type="date" placeholder='Tanggal' className="form-control text-dark" id='tanggal' value={tanggal} onChange={(e) => setTanggal(e.target.value)} />
                                    </div>
                                    <div className="form-group">
                                                ...
                                                <div className="modal-dialog">
                                                    <div className="modal-content">
                                                        ...
                                                        <div className="modal-footer">
                                                            <button type="button" className="btn btn-primary" data-dismiss="modal" value={jdw.id} onClick={(e) => hapusJadwalSholat(e.target.value)} >Hapus Data</button>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
